...
namespace MVC.Controllers
{
    public class EFEmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpID,EmpName,Designation,Department,JoiningDate")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpID,EmpName,Designation,Department,JoiningDate")] Employee employee)
        {
            if (ModelState.IsValid)
            {
